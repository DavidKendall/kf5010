...
The script below is taken from the [lecture in week 2]({{ site.baseurl }}/assets/ra/B02.pdf).
...
example from the [lecture in week 3]({{ site.baseurl }}/kf5010/assets/ra/B03.pdf).
