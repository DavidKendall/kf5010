...
The script below is taken from the [lecture in week 2]({{ site.baseurl }}{{site.raurl}}/B02.pdf).
...
example from the [lecture in week 3]({{ site.baseurl }}{{site.raurl}}/B03.pdf).
